...
class BlockChain(object):
    ...
    def new_transaction(self,number,cmdb_ci,incident_state,active,caller_id,opened_by,opened_at,location,impact,urgency,problem_id):
...
def new_transaction():
    ...
    required = ['number','cmdb_ci', 'incident_state', 'caller_id', 'opened_by', 'opened_at', 'active' , 'location', 'urgency', 'problem_id','impact']
    ...
    index = blockchain.new_transaction(
        ...
        cmdb_ci = values['cmdb_ci'],
        active = values['active'],
        incident_state = values['incident_state'],
